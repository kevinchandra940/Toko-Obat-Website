...
import {getProductMata} from '../actions'
import {Link} from 'react-router-dom'


class Matapage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {}
    }
    ...
    componentDidMount() {
       this.props.getProductMata()
       console.log(this.props.getProductMata())
    }
    ...
    render() {
        ...
        return (
            ...
            <h1 style={styles.title}>PENYAKIT MATA</h1>
...
const mapStateToProps = (state) => {
    return {
        products : state.productReducer.productMata 
    }
}

export default connect(mapStateToProps,{getProductMata})(Matapage);