...
import {getProductDemam} from '../actions'
import{Link} from 'react-router-dom'


class Demampage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {}
    }
    ...
    componentDidMount() {
       this.props.getProductDemam()
       console.log(this.props.getProductDemam())
    }
    ...
    render() {
        ...
        return (
            ...
            <h1 style={styles.title}>DEMAM</h1>
...
const mapStateToProps = (state) => {
    return {
        products : state.productReducer.productDemam
    }
}

export default connect(mapStateToProps,{getProductDemam})(Demampage);